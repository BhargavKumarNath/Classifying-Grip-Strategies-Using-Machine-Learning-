...
st.markdown("Here, we investigate the characteristics of each dataset to understand the experimental design, data quality, and key kinamatic patterns.")
...
""")
    ...
    with tab4:
        ...
        st.markdown("""
        PCA helps us visualise the high dimensional kinematic data in a 2D space. The key question is: **Do the experimental conditions create seperable clusters in the data?**
""")
        with st.spinner("Running PCA and Generating plots..."):
            ...
            st.pyplot(fig_pca)
            st.success("""
            **Key Finding:** The seperation is most distinct when coloured by **distance** or **target position**. This strongly suggests that the primary factor driving the variance in movement kinematics is the target's location, which is a foundational finding for our modeling phase.
""")